...
public class HashMapPerformanceBenchmark {
    ...
    @Benchmark
    public HashMap<Integer, String> benchmarkConstructor() {
        return new HashMap<>();
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(HashMapPerformanceBenchmark.class.getSimpleName())
                .forks(3)
                .result("hashmap-results.csv")
    ...
    private static void writeCustomCsv(Collection<RunResult> results) {
        try (FileWriter writer = new FileWriter("HashMap_jmh_performance.csv")) {
            ...
            System.out.println("JMH Performance report saved: HashMap_jmh_performance.csv");
        } catch (IOException e) {
